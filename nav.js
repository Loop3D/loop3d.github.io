let navbar = (function () {
	...
	createHTML = (currentPage) => {
		let html = [
			...
			'<a href="publications.html" class="nav-link w-nav-link %"><b>Downloads & Articles</a>',
			...
			'<a href="p3Dconference2025.html" class="nav-link w-nav-link %" "><b>3D Modelling conference 2025</a>',
